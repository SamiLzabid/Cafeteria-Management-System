		...
		while(choice)
		{
			...
			switch(first)
			{
				case 1:					
					...
					System.out.println("1. This service is only for the students who register EWU Automated Food & Beverage Service.");
					System.out.println("2. Registration cost is 2500tk per semester.");
					System.out.println("3. Registered person can take several meals in a day. (per meal cost will be deducted from 2500tk every time)");
				...
				case 2:
					...
					switch(second)
					{
						case 1:
							...
							s.setName(name);
							s.setPassword(p);
							s.setBalance(2500);		//according to terms and condition the default balance value of a registered student is 4500TK
							afb.insertStudent(s);
							afb.getStudent(id);
							afb.showAllStudents();
						break;
